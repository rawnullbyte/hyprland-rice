...
Item {
    ...
    readonly property color normalColor: {
        if (isCritical) return Qt.rgba(pywal.error.r, pywal.error.g, pywal.error.b, 1.0)
        if (isLow) return Qt.rgba(pywal.warning.r, pywal.warning.g, pywal.warning.b, 1.0)
    ...
    readonly property color chargingColor: Qt.rgba(pywal.primary.r, pywal.primary.g, pywal.primary.b, 1.0)
    readonly property color liquidColor: Qt.rgba(pywal.primary.r, pywal.primary.g, pywal.primary.b, 0.8)
